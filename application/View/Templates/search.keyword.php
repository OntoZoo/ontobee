...
<form action="<?php echo SITEURL; ?>ontology" method="get" id="form_term_search">

<?php

if ( isset( $ontologies ) && !isset( $ontology ) ) {
...
<input id="keywords" name="keywords" size="30" />
    <input type="submit" name="search" value="Search terms" />
</div>
</form>