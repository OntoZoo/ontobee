...
<?php 
require VIEWPATH . 'Templates/search.keyword.php';
?>

<!-- Ontobee go to term -->
<form action="<?php echo SITEURL ?>ontology" method="get" id="form_term_redirect" style="margin-top:16px;">
