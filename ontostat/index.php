...
Purpose: Ontobee statistic section index page.
-->
...
<div id="topnav"><a href="../index.php" class="topnav">Home</a><a href="../introduction.php" class="topnav">Introduction</a><a href="index.php" class="topnav">Statistics</a><a href="../sparql/index.php" class="topnav">SPARQL</a><a href="../ontobeep/index.php" class="topnav">Ontobeep</a><a href="../tutorial/index.php" class="topnav">Tutorial</a><a href="../faqs.php" class="topnav">FAQs</a><a href="../references.php" class="topnav">References</a><a href="../links.php" class="topnav">Links</a><a href="../contactus.php" class="topnav">Contact</a><a href="../acknowledge.php" class="topnav">Acknowledge</a><a href="../news.php" class="topnav">News</a></div>
<div id="mainbody">
...
$classTotal += $cCount;
$annotationTotal += $aCount;
$datatypeTotal += $dCount;
$objectTotal += $oCount;
$totalTotal += $total;
...
?>
	<tr align="center" height="25" <?php if ($index %2 == 0) { echo "bgcolor = \"#CCECFB\"";} ?>>
		...
		<td><?php echo number_format($oCount); ?></td>
		<td><?php echo number_format($dCount); ?></td>
		<td><?php echo number_format($aCount); ?></td>
...
?>
	<tr align="center" height="25" <?php if ($index %2 == 0) { echo "bgcolor = \"#CCECFB\"";} ?>>
		...
		<td>-</td>
		<td><strong><?php echo number_format($classTotal); ?></strong></td>
		<td><strong><?php echo number_format($objectTotal); ?></strong></td>
		<td><strong><?php echo number_format($datatypeTotal); ?></strong></td>
		<td><strong><?php echo number_format($annotationTotal); ?></strong></td>
		<td><strong><?php echo number_format($totalTotal); ?></strong></td>
	</tr>
</table>
